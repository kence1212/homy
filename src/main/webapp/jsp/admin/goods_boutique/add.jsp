...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div id="positionDiv" class="form-group-col-2" >
			...
			<div class="form-cont">
				<input id="position" type="text" name="position" lay-filter="position"  placeholder="请输入不大于三位的数字" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div id="positionDiv" class="form-group-col-2" >
			...
			<div class="form-cont">
				<input  type="text" name="sort" lay-verify="required|number" placeholder="推荐排序" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="desc" lay-verify="required|desc" placeholder="推荐描述" class="form-control form-boxed">
			</div>
		</div>
