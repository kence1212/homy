...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="tel" name="storeName" lay-verify="required|storeName" value="${bean.storeName }"  placeholder="店铺名称" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">图标上传：</div>
			<div id="icon_container" class="form-cont">
				<input type="hidden" name="storeIcon" value="${bean.storeIcon }">
				<ul class="imgList">
					...
					<li class="mb-10" id="iconShow">
						<img src="/homy${bean.storeIcon }" height="100%" />
					</li>
				</ul>
			</div>
		</div>
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="storeDesc" value="${bean.storeDesc }" placeholder="店铺描述" class="form-control form-boxed">
			</div>
		</div>
