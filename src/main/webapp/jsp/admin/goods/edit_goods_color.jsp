...
<div class="main-wrap">
    <div class="page-wrap">
        ...
        <div class="form-group-col-2">
            ...
            <c:forEach items="${colorList }" var="bean">
            <div class="form-cont">
                <input type="text" name="name" value="${bean.name }" readonly="readonly" class="form-control form-boxed mr-5 mb-5" style="width: 300px;">
            ...
            <div class="form-cont add-block">
                <input type="text" name="colorName" value="" class="form-control form-boxed mr-5 mb-5" style="width: 300px;">
...
<script>
    ...
    function addSize(){
    	...
    	parent.layer.confirm("增加此项？",function(){
	    	$.post(
	    		"addGoodsColor.do",
	    		{"goodsId":goodsId,"name":colorName},
	    		function(result){
	    			if(result.resultCode == "10000"){
