...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="name" lay-verify="required|name" placeholder="模块名称" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">模块编码：</div>
			<div class="form-cont">
				<input type="tel" name="code" lay-verify="required|number|code" placeholder="1表示1级模块，2表示2级模块" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">模块样式：</div>
			<div class="form-cont">
				<input type="tel" name="iconClass" lay-verify="required|iconClass" placeholder="模块样式" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
	  ...
	  form.on('submit(*)', function(data){   
		/*   parent.layer.load(3,{shade:[0.5,'#000'],time:0});
		  ...
		  parent.layer.confirm("确定保存吗？",{},function(){
			  $.post("<%=request.getContextPath()%>"+"/ampmodel/add.html",
					  $("#saveForm").serialize(),
					  function(data){
