	...
	<div class="page-wrap">
		...
		<table class="table mb-15">
			...
			<tr class="cen">
				...
				<td class="lt"><a href="#">${bean.brandName}</a></td>
				<td>${bean.brandCode}</td>
				<td><fmt:formatDate value="${bean.createTime }" pattern="yyyy-MM-dd"/></td>
				<td>${bean.tsort}</td>
				<td>
					<a title="编辑" class="mr-5" href="toEdit.html?id=${bean.brandId }">编辑</a>
					<a title="详情" class="mr-5">详情</a>
					<a title="删除" onclick="deleteData(${bean.brandId })">删除</a>
				</td>
			</tr>
			</c:forEach>
			</tbody>
