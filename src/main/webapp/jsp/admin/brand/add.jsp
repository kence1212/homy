...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="brandName" lay-verify="required|brandName" placeholder="品牌名称" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">品牌代码：</div>
			<div class="form-cont">
				<input type="tel" name="brandCode" lay-verify="required|brandCode" placeholder="品牌代码" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">品牌排序：</div>
			<div class="form-cont">
				<input type="text" name="tsort" lang="en" lay-verify="required|number|tsort"  placeholder="品牌排序" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="brandDesc" lay-verify="brandDesc" placeholder="摘要" class="form-control form-boxed">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">备注：</div>
			<div class="form-cont">
				<textarea name="remark" class="form-control form-boxed"></textarea>
			</div>
		</div>
