...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="title" value="${bean.title }" lay-verify="required" placeholder="轮播图标题" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<c:if test="${bean.type==1 }">
			<div id="urlDiv" class="form-group-col-2" style="display: none">
				...
				<div class="form-cont">
					<input id="targetUrl" type="text" name="targetUrl"  placeholder="轮播图地址" class="form-control form-boxed" style="width:300px;">
				</div>
			</div>
		...
		<c:if test="${bean.type==2 }">
			<div id="urlDiv" class="form-group-col-2" >
				<div class="form-label">轮播图地址：</div>
				<div class="form-cont">
					<input id="targetUrl" value="${bean.targetUrl }" type="text" name="targetUrl" lay-verify="targetUrl" placeholder="轮播图地址" class="form-control form-boxed" style="width:300px;">
				</div>
			</div>
			
			<div id="goodsDiv" class="form-group-col-2" style="display: none">
				<div class="form-label">商&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;品：</div>
				<div class="form-cont">
					<input id="goodsId" type="hidden" name="goodsId">
					<input type="text"  id="goodsName"  placeholder="请选择" class="form-control form-boxed formpoup formpoupIframe" data-url="<%=request.getContextPath()%>/silder/classify.html" style="width:300px;">
		...
		<div  class="form-group-col-2" >
			...
			<div class="form-cont">
				<input type="text" name="sort" value="${bean.sort }" lay-verify="required|number" placeholder="9位以内数字" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
...
//选中类型
$("#typeId option[value='${bean.type}']").attr("selected",true);
