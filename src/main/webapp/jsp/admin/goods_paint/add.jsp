...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="paintName" lay-verify="required|paintName" placeholder="油漆名称" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">油漆代码：</div>
			<div class="form-cont">
				<input type="text" name="paintCode" lay-verify="required|paintCode" placeholder="油漆代码" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">油漆描述：</div>
			<div class="form-cont">
				<input type="text" name="paintDesc" placeholder="油漆描述" class="form-control form-boxed">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="submit" lay-submit lay-filter="*" class="btn btn-primary" value="新建" />
			</div>
		</div>
		<!--开始::结束-->
		</form>
