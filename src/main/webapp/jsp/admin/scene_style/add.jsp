...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="title" lay-verify="required|name" placeholder="场景标题" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="tel" name="sceneDesc" lay-verify="required" placeholder="场景描述" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
	    ...
	    <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <select  style="width:600px;" name="sceneInitId" >
	  ...
	  form.on('submit(*)', function(data){   
		/*   parent.layer.load(3,{shade:[0.5,'#000'],time:0});
		  ...
		  parent.layer.confirm("确定保存吗？",{},function(){
			  $.post("<%=request.getContextPath()%>"+"/amscenestyle/add.html",
					  $("#saveForm").serialize(),
					  function(data){
