...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="name" lay-verify="required|name" placeholder="分类名称" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">分类编码：</div>
			<div class="form-cont">
				<input type="text" name="code" lay-verify="required|name" placeholder="分类编码" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">分类排序：</div>
			<div class="form-cont">
				<input type="tel" name="sort" lay-verify="required|number|code" placeholder="场景排序" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">分类描述：</div>
			<div class="form-cont">
				<input type="tel" name="desc" lay-verify="required" placeholder="场景描述" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
	  ...
	  form.on('submit(*)', function(data){   
		/*   parent.layer.load(3,{shade:[0.5,'#000'],time:0});
		  ...
		  parent.layer.confirm("确定保存吗？",{},function(){
			  $.post("<%=request.getContextPath()%>"+"/amscenecategory/add.html",
					  $("#saveForm").serialize(),
					  function(data){
