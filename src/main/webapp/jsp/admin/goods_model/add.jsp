	...
	<div class="page-wrap">
		...
		<form id="saveForm" action="add.html" class="layui-form" method="POST">
		 ...
		 <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <select lay-filter='typeId' style="width:auto;" name="type">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text"  name="modelHeight" lay-verify="number|modelHeight" placeholder="模型高度" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="tel"  name="modelWidth" lay-verify="number|modelWidth"" placeholder="模型宽度" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text"  name="modelLength" lang="en" lay-verify="number|modelLength"  placeholder="模型长度" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="modelVersion" lang="en" lay-verify="required"  placeholder="模型版本" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="modelTag" lang="en" lay-verify="required"  placeholder="模型标签" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				...
				<input type="text"  lay-verify="required" placeholder="请选择" class="form-control form-boxed formpoup formpoupIframe" data-url="<%=request.getContextPath()%>/ammodel/classify.html" style="width:300px;">
			</div>
		</div>
		
		<div class="form-group-col-2" id="colorIdDiv">
		...
		<div class="form-group-col-2" id="sizeIdDiv">
		...
		<div class="form-group-col-2" id="textureIdDiv">
		...
		<div class="form-group-col-2">
			...
			<div id="icon_container" class="form-cont">
				<input type="text" style="display:none;" name="modelIcon" >
				<ul class="imgList">
		...
		<div id="fileDiv" class="form-group-col-2">
			...
			<div id="file_container" class="form-cont">
				<input type="text" id="fileName" class="form-control form-boxed" style="width:300px;">
		...
		<div id="photoDiv" style="display: none" class="form-group-col-2">
...
function setHeadImg(baseImg){
    $("#iconPicks").html("<i class='icon-cut'></i><img src='"+baseImg+"' width='200' height='150'>");
    $("#iconPicks").addClass('editorImg');
    $("input[name='modelIcon']").val(baseImg);
}
$('#iconPicks').on('click',function(){
	var layOpen = parent.layer.open({
		type: 2,
		title:'图片编辑',
		area:['1200px','900px'],
		fixed:false,
	...
	layui.use('form', function(){
	  ...
	  form.on('submit(*)', function(data){   
		 ...
		 /*  parent.layer.load(3,{shade:[0.5,'#000'],time:0});
		  $('.layui-form').submit(); */
			parent.layer.confirm("确定保存？",{},function(){
	   			 $.post("<%=request.getContextPath()%>"+"/ammodel/add.html",
	   				  $("#saveForm").serialize(),
	   				  function(data){
