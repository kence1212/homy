    ...
    <div class="page-wrap">
        ...
        <div class="form-group-col-2">
         ...
         <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <select style="width:auto;" name="colorId">
         ...
         <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <select style="width:auto;" name="sizeId">
         ...
         <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <select style="width:auto;" name="textureId">
       ...
       <div class="form-group-col-2">
     	 ...
     	 <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <input type="text" placeholder="商品库存" name="stock" value="30" lay-verify="required" class="form-control form-boxed" style="width: 200px;">
            </div>
        </div>
         ...
         <div class="form-group-col-2">
            ...
            <div class="form-cont">
                <input type="text" placeholder="商品价格" name="price" value="100" lay-verify="required" class="form-control form-boxed" style="width: 200px;">
            </div>
        </div>
    	...
    	layui.use('form', function(){
   		  ...
   		  form.on('submit(*)', function(data){   
   			...
   			parent.layer.confirm("确定保存？",{},function(){
   			 $.post("<%=request.getContextPath()%>"+"/amsku/add.html",
   				  $("#saveForm").serialize(),
   				  function(data){
