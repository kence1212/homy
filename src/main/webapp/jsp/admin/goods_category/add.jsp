...
<div class="main-wrap">
	<div class="page-wrap">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="categoryName" lay-verify="required|categoryName" placeholder="分类名称" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">分类代码：</div>
			<div class="form-cont">
				<input type="text" name="categoryCode" lay-verify="required|categoryCode" placeholder="分类代码" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
			<div class="form-label">分类排序：</div>
			<div class="form-cont">
				<input type="text" name="tsort" lay-verify="required" placeholder="分类排序" class="form-control form-boxed" style="width:300px;">
			</div>
		</div>
		<div class="form-group-col-2">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<select style="width:auto;" name="categoryType">
		...
		<div class="form-group-col-2">
			...
			<div id="icon_container" class="form-cont">
				<input type="text" style="display:none;" name="icon">
				<ul class="imgList">
		...
		<div class="form-group-col-2">
			...
			<div id="icon_container2" class="form-cont">
				<input type="text" style="display:none;" name="appClientIcon">
				<ul class="imgList">
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="categoryDesc" placeholder="分类描述" class="form-control form-boxed">
			</div>
		</div>
...
function img2(){
	...
	categoryIcon.bind('FileUploaded', function(up, file, info) {//上传完毕
        ...
        if (response.status) {
           $("#iconPicks2").html("<img src='<%=contextPath%>"+response.fileUrl+"' width='200' height='150'>");
