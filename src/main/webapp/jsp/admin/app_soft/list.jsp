	...
	<div class="page-wrap">
		...
		<table class="table mb-15">
			...
			<tr class="cen">
				...
				<td class="lt"><a href="#">${bean.appCode}</a></td>
				<td>${bean.appVersion}</td>
				<td>${bean.appVersionStr}</td>
				<td>
					<c:if test="${bean.appType == 1}">Android</c:if>
					<c:if test="${bean.appType == 0}">IOS</c:if>
				</td>
				<td>
					<c:if test="${bean.compelUpdate}">是</c:if>
					<c:if test="${!bean.compelUpdate}">否</c:if>
				</td>
