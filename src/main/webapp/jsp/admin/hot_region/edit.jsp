	...
	<div class="page-wrap">
		...
		<c:if test="${bean.type==1 }">
			<div id="positionDiv" class="form-group-col-2" >
				...
				<div class="form-cont">
					<input id="position" type="text" name="position" value="${bean.position }" placeholder="图片位置" class="form-control form-boxed" style="width:300px;">
				</div>
			</div>
		</c:if>
		...
		<div class="form-group-col-2">
			...
			<div class="form-cont">
				<input type="text" name="desc" value="${bean.desc }" lay-verify="required" placeholder="推荐描述" class="form-control form-boxed">
			</div>
		</div>
